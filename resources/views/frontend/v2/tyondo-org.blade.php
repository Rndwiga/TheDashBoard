...
<html lang="en">
    ...
    <body>
        ...
        <div id="main-wrap">
            ...
            <header id="header" class="fixed transparent">
                <nav class="navbar navbar-default white">
                    <!--  Header Logo  -->
                    <div id="logo">
                        <a class="navbar-brand" href="index-corporate.html">
                            <img src="{{asset('frontend/assets/img/logo.png')}}" class="normal" alt="logo">
                            <img src="{{asset('frontend/assets/img/logo%402x.png')}}" class="retina" alt="logo">
                    ...
                    <div id="menu-classic">
                        <div class="menu-holder">
                            <ul>
                                <li class="submenu">
                                    <a href="index-corporate.html" class="active-item">Home</a>
                                </li>
                                <li class="submenu">
        ...
        <script type="text/javascript" src="{{asset('frontend/assets/js/smooth.scroll.min.js')}}"></script>
