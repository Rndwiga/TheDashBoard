              ...
              <div class="content-body">
                  <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                           <form action="{{ url('ContactDetails/' . $sContact->id) }}" method="post" enctype="multipart/form-data">
                           <input name="_method" type="hidden" value="patch">
                           <input name="contactId" type="hidden" value="{{$sContact->contactId}}">
                           {{ csrf_field() }}
                              <div class="form-group">
                                  <div class="row">
                                    <div class="col-lg-3"><label class="form-label" for="field-1">Contact Image</label></div>
                                    <div class="col-lg-9"><input type="file" value="{{asset($sContact->contact_picture)}}" name="contact_picture" class="form-control" id="field-5"></div>
                                  </div>
                              </div>
                              <div class="form-group">
                                  <div class="row">
                                    <div class="col-lg-4"><label class="form-label" for="field-3">Name</label></div>
                                    <div class="col-lg-8"><input type="text" name="name" value="{{$sContact->name}}" class="form-control" id="field-5"></div>
                                  </div>
                              </div>
                              <div class="form-group">
                                  <div class="row">
                                    <div class="col-lg-4"><label class="form-label" for="field-2">Phone</label></div>
                                    <div class="col-lg-8"><input type="text" name="mobile" value="{{$sContact->mobile}}" class="form-control" id="field-5"></div>
                                  </div>
                              </div>
                              <div class="form-group">
                                  <div class="row">
                                    <div class="col-lg-4"><label class="form-label" for="field-3">Address</label></div>
                                    <div class="col-lg-8"><input type="text" name="address" value="{{$sContact->address}}" class="form-control" id="field-5"></div>
                                  </div>
                              </div>
                              <div class="form-group">
                                  <div class="row">
                                    <div class="col-lg-4"><label class="form-label" for="field-3">Profession</label></div>
                                    <div class="col-lg-8"><input type="text" name="profession" value="{{$sContact->profession}}" class="form-control" id="field-5"></div>
                                  </div>
                              </div>
                          </div>

                          <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12 padding-bottom-30">
                            <img class="img-responsive" src="{{ asset($sContact->contact_picture)}}" alt="" style="max-width:120px;">
                            <br />
