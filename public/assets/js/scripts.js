...
jQuery(function($) {
    ...
    ULTRA_SETTINGS.mailboxInbox = function() {
        ...
        //  var selectedCountry = $(".mail_list .open-view").val();
        //  var selectedCountry = $('.mail_list .open-view input:hidden').val();
          var selectedCountry = $('.mail_list .open-view input:hidden').attr('id');
      /*    var selectedCountry = $('.mail_list .open-view input:hidden').map(function(){
                                         return this.value;
                                      }).get();
                            console.log(selectedCountry.);
        */
              var cross = $('meta[name=csrf-token]').attr('content');
          ...
          //  window.location = 'mail-view.html';
                  ...
                  $.ajax({
                    ...
                    url: '/Emails/' + selectedCountry, // This is the url we gave in the route
                  //  data: {'id' : selectedCountry}, // a JSON object to send back
